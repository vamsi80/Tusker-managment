...
# The Prisma schema + generated client now live in the @tusker/db workspace
# package, which apps/web resolves through a symlink into /app/packages/db.
COPY --from=builder --chown=nextjs:nodejs /app/packages/db /app/packages/db
