...
describe("GET /vendors/:id/materials", () => {
  ...
  it("lets a member with no project rows read the list", async () => {
    ...
    (fetchWorkspacePermissions as any).mockResolvedValueOnce({
